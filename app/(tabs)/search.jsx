    ...
    ({ item }) => (
      ...
      >
        ...
        <View style={tw`flex-1`}>
          ...
          <Text
            style={tw`text-[9px] text-slate-400 font-bold uppercase tracking-wide`}
          >
    ...
    >
      ...
      >
        <View style={tw`flex-row items-center`}>
          ...
          <View
            style={tw`flex-1 bg-white/15 rounded-full flex-row items-center px-3 border border-white/30`}
          >
      ...
      {isLoading ? (
        ...
        <View style={tw`flex-1 items-center justify-center px-6`}>
          ...
          <Text
            style={tw`text-xs text-slate-400 font-medium text-center leading-relaxed`}
          >
            Ketikkan kata kunci seperti "Pelantikan", "Upacara", atau "Sumpah"
            untuk mencari pedoman protokol dengan cepat.
          </Text>
        </View>
      ) : scenarios.length > 0 ? (
        <View style={tw`flex-1 px-5 pt-4`}>
          <Text
            style={tw`text-[10px] font-bold text-slate-300 uppercase tracking-wider mb-3 ml-1`}
          >
        ...
        <View
          style={tw`flex-1 mx-5 bg-slate-800/80 border border-dashed border-slate-600 p-8 rounded-2xl items-center justify-center mt-6`}
        >
